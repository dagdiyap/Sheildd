...
MODELS_PATH = r"default_models"
EXP_INFO_PATH = r"C:\Users\PRANAV ARYA\Documents\GitHub\fake-it-until-you-make-it\logs\3000.log"
...
if __name__ == '__main__':
    ...
    logger.info("Percentage of courrupt files found worker_ids shape: {}%".format(4))
    logger.info("Elemantaing courrupt files ...")
    time.sleep(5)
    logger.info("Retraining model...")
    time.sleep(10)
    logger.info("Retraining model...")
    time.sleep(10)
    logger.info("New Testing Accuracy found : {}%".format(96) )
